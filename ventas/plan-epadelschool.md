...
|---|---|---|---|
| Inicial | 0 | Problema + prueba + ask | `bolsa de horas` |
| Follow-up 1 | 3 | Dato nuevo (20h/semana) | `20h a la semana` |
| Follow-up 2 | 7-8 | Caso similar / prueba social | `cómo lo hace [club similar]` |
| Follow-up 3 | 14 | Insight nuevo + oferta demo | `roi del software` |
| Follow-up 4 | 21-28 | Breakup (formato 1-2-3) | `cierro el hilo` |
...
**Touch 5 — Día 21-28 (breakup, formato 1-2-3)**
Asunto: `cierro el hilo`

> Como no he sabido nada, lo dejo simple. Responde con un número:
>
> 1 — Me interesa, hablemos
> 2 — Ahora no, contacta en 3 meses
> 3 — No me interesa, no escribas más
>
> Sin problema si es la 3 — mucha suerte con {{club}}.
